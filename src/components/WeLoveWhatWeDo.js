...
export default function WeLoveWhatWeDo() {
    return (
        <div className='w-3/5 mx-auto mobile:w-full flex mobile:flex-wrap-reverse mb-40'>
            {/* Sol Div */}
            <div className='flex flex-row mobile:w-full mobile:pl-10 gap-4'>
                <img src={WeLoveWhatWeDo1} alt='resim' />
                <img src={WeLoveWhatWeDo2} alt='resim2' />
            </div>
            {/* Sağ Div */}
            <div className='w-1/3 mx-[8rem] mobile:mx-auto my-[8rem] '>
