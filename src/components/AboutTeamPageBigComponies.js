...
export default function AboutTeamPageBigComponies() {
    return (
        <div className='w-[90rem] mx-auto mt-24 flex flex-col justify-center items-center'>
            ...
            <div className="text-center font-semibold text-[#737373] mt-6">Problems trying to resolve the conflict between <br/>the two major realms of Classical physics: Newtonian mechanics</div>
        </div>
    );
}