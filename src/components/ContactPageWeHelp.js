...
export default function ContactPageWeHelp() {
    return (
        <div className='w-[90rem] mx-auto py-[7rem] text-center'>
            ...
            <div className='flex h-[25rem]'>
                <div className='w-[33.3%] px-[2.5rem] py-[3.12rem] pt-20'>
                ...
                <div className='w-[33.3%] px-[2.5rem] py-[3.12rem] pt-20 bg-[#252B42]'>
